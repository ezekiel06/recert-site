...
Fixes are shipped as new app versions through the Atlassian Marketplace. Customers receive
them automatically once Atlassian's review completes; timing of that review is outside our
control.

## Data

The app stores no data outside the customer's Atlassian site. See the
[privacy policy](privacy.html) for what is stored and for how long, and the
[security page](security.html) for how access to it is controlled.
